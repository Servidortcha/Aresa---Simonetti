...
import { ArrowRightLeft, ArrowDownCircle, ArrowUpCircle, CheckCircle2 } from "lucide-react";
...
export default function IngresoEgresoPage() {
  ...
  return (
    <>
      ...
      <form onSubmit={submit} className="bg-white border border-line rounded-sm p-4 sm:p-6 max-w-lg">
        {esAdmin && (
          <Field label="Stock">
