-- ============================================================
-- 0019_ajustes_signed.sql
-- Los ajustes de stock guardan la cantidad CON SIGNO (positivo si
-- subió el stock, negativo si bajó) para que aparezca el + / - en
...
begin
  ...
  -- Guarda la cantidad CON SIGNO: + sube el stock, - lo baja.
