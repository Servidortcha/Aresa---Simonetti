    ...
    <>
      ...
      <div className="bg-ink text-paper px-4 py-2.5 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            <AresaMark />
            <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }} className="text-sm">Aresa</span>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-1.5">
            <AresaMark />
            <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }} className="text-base">Aresa</span>
          </div>
