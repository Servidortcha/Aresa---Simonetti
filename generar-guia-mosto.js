/* Genera la Guia de uso (mosto@simonetti.local) en PDF */
const fs = require("fs");
...
doc.text("USUARIO", M + 6, 150);
doc.setFont("Arial", "normal");
doc.setFontSize(9);
doc.text("Correo: mosto@simonetti.local", M + 6, 158);
doc.text("Pantalla inicial: Partes diarios", M + 6, 163.5);
doc.text("Modulos: Partes diarios (su frente) e Inglete", M + 6, 169);
...
espaciado(2);
parrafo("El ERP Aresa es el sistema de gestion de Simonetti Montajes Industriales. Con tu usuario podes cargar y consultar los partes diarios del frente de obra que tenes asignado y usar la calculadora de ingletes del taller.");
parrafo("Para ingresar: abri la aplicacion en el navegador (Google Chrome recomendado), escribi tu correo mosto@simonetti.local y tu contrasena, y toca \"Ingresar\".");
...
parrafo("Solo ves el frente (o los frentes) asignados a tu usuario. No podes ver los partes de otros frentes.");
...
subtitulo("2.2 El frente Bunge Tancacha");
parrafo("Si tu frente es Bunge Tancacha, el formulario muestra dos campos extra:");
viñeta("N de parte diario de Bunge: el numero interno que pide el cliente.");
viñeta("Horas por persona del sector: para cada persona de la escuadrilla indicas las horas trabajadas. Los nombres se sugieren desde el organigrama y podes agregar mas con \"Agregar persona\".");
...
footer();
doc.save("Guia de uso - mosto@simonetti.local.pdf");
